...
class Event(db.Model):
    ...
    event_type = db.Column(db.Enum('booked', 'window', 'blocked', 'completed', 'leave', 'birthday', name='event_type_enum'), nullable=False) # Type of event (e.g., booked, window, blocked, completed)
