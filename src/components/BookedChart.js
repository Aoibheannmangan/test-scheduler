  ...
  const { appointmentData, noShowData, outOfWindowData, availableYears } =
    useMemo(() => {
      ...
      Array.from(years).forEach((year) => {
        ...
        noShowData[year] = yearData[year]?.noShows || new Array(12).fill(0);
    ...
    <Box sx={{ width: "100%", padding: 2 }}>
      ...
      <Box sx={{ width: "100%", height: 400 }}>
        <BarChart
          ...
          series={[
            {
              data: appointmentData[selectedYear] || new Array(12).fill(0),
              label: "Appointments",
              stack: "total",
              color: "#0e9757c9",
            },
            {
              data: noShowData[selectedYear] || new Array(12).fill(0),
              label: "No-show in",
              stack: "total",
              color: "#ca3609d2",
            },
            {
              data: outOfWindowData[selectedYear] || new Array(12).fill(0),
